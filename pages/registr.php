        ...
        <div class="about__contacts">
            ...
            <div class="about__wrapper" style="display: block; width:100%; text-align:center;">
                <div class="about__form">
                    <form action="/vendor/registr.php" method="post" class="about__form-action">
                        <label for="">Email</label><br>
                        <input type="email" name="email" require style="width:40%;"><br>
                        ...
                        <button style="display: inline; width:30%;" type="submit" class="about__form-button">Зарегистрироваться</button><br><br>
                        <a href="/pages/login.php" style="margin-top: 30px;">Авторизация</a>
                    </form>
                </div>
            </div>
        </div>

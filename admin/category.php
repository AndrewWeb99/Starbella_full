...
<body>
    ...
    <div class="container">
        ...
        <form action="/admin/vendor/add_category.php" method="post" enctype="multipart/form-data">
            <h1 class="title_main">Добавить категорию</h1>
            <div class="facts_sections">
                <div class="facts_one_section">
                    ...
                    <div class="field">
                        ...
                        <input type="file" name="img_cat" id="pct" required />
                        <p for="" id="pct_l"></p>
                    </div>
                </div>
        ...
        <h1 class="title_main">Удалить или изменить категорию</h1>
        <div class="facts_one_section">
                        ...
                        foreach ($cep as $num) {
                            ...
                            echo '
                                        <tr>
                                            ...
                                            <td><a class="button_table" href="/admin/vendor/delete_category.php?num=' . $num[0] . '">Удалить</a></td>
                                            <td><a class="button_table" href="/admin/vendor/update_category.php?num=' . $num[0] . '">Изменить</a></td>
                                        </tr>                              
                                            ';
                        }
                    } else {
